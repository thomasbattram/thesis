...
```{r call-source-03}
read_chunk("~/Desktop/projects/Main_project/thesis/index/chunks/03-ewas_catalog.R")
```
...
```{r catalog-project-workflow, fig.cap = '(ref:catalog-project-workflow-cap)', fig.align = "center", out.width = "100%", results = "asis"}
```
...
EWAS were conducted for `r n_aries` continuous and binary traits in peripheral blood DNA methylation of ALSPAC mothers in middle age (N = 940), generated as part of the Accessible Resource for Integrated Epigenomics Studies (ARIES) project [@Relton2015].
...
```{r catalog-use, fig.cap = catalog_cap, fig.align = "center", out.width = "100%", results = "asis"}
```
