...
There was strong evidence of an inverse association between variance at a CpG site and effect size (P = XXX, __Table X__),
...
There was strong evidence of an association between mean DNA methylation levels and negative effect sizes (P = XXX, __Table X__) and an inverse association between mean methylation levels and positive effect sizes (P = XXX, __Table X__).
...
The variance in effect size estimates explained by DNA methylation variability, mean methylation level, and heritability, was XXX (__Table X__).  
