...
```{r fig1-07, message=FALSE, results="asis", fig.cap='(ref:fig1-07-cap)', fig.scap='(ref:fig1-07-scap)'}
```
...
```{r fig2-07, message=FALSE, results="asis", fig.show = "hold", out.width = "50%", fig.align = "default", fig.cap='(ref:fig2-07-cap)', fig.scap='(ref:fig2-07-scap)'}
```
...
```{r fig4-07, message=FALSE, results="asis", fig.show = "hold", out.width = "50%", fig.align = "default", fig.cap='(ref:fig4-07-scap)'}
```
