...
```{r fig1-07, message=FALSE, results="asis", fig.cap='(ref:fig1-07-cap)'}
```
...
```{r fig2-07, message=FALSE, results="asis", fig.show = "hold", out.width = "50%", fig.align = "default", fig.cap='(ref:fig2-07-cap)'}
```
...
```{r fig3-07, message=FALSE, results="asis", fig.cap='(ref:fig3-07-cap)'}
```
...
```{r sup-fig1-07, message=FALSE, results="asis", fig.cap='(ref:sup-fig1-07-cap)'}
```
...
```{r sup-fig2-07, message=FALSE, results="asis", fig.cap='(ref:sup-fig2-07-cap)'}
```
...
```{r sup-fig3-07, message=FALSE, results="asis", fig.cap='(ref:sup-fig3-07-cap)'}
```
...
```{r sup-fig4-07, message=FALSE, results="asis", fig.cap='(ref:sup-fig4-07-cap)'}
```
...
```{r sup-fig5-07, message=FALSE, results="asis", fig.cap='(ref:sup-fig5-07-cap)'}
```
...
```{r fig4-07, message=FALSE, results="asis", fig.show = "hold", out.width = "50%", fig.align = "default", fig.cap='(ref:fig4-07-cap)'}
```
