...
\item
  Group B - a subset of group A, all sites associated with any complex trait at a more stringent threshold, P\textless1.6x10\textsuperscript{-10}. Multiple EWAS were conducted to produce the results in the database and so the stricter threshold of group B aimed to limit the false discovery rate by taking into account the multiple EWAS.
\item
...
\subsection{Understanding CpG characteristics}\label{understanding-cpg-characteristics}}
...
Probes were excluded if they were present on either of the sex chromosomes, a SNP/control probe, had a detection p value \textgreater{} 0.05 across over 10\% of samples or were identified as problematic by Zhou et al. (92). This left 421,693 CpG sites for analyses.
