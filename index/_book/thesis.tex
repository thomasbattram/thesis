...
\hypertarget{using-dna-methylation-to-infer-other-epigenetic-marks}{%
\subsubsection{Using DNA methylation to infer other epigenetic marks}\label{using-dna-methylation-to-infer-other-epigenetic-marks}}
\begin{itemize}
\tightlist
\item
...
\end{itemize}
\hypertarget{use-of-dna-methylation-in-a-population-setting}{%
\section{Use of DNA methylation in a population setting~}\label{use-of-dna-methylation-in-a-population-setting}}
\begin{itemize}
\tightlist
\item
