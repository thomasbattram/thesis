...
\bottomrule
\multicolumn{13}{l}{\textsuperscript{} * = SNP used as an instrumental variable was not replicated in the independent dataset (NSHDS)}\\
...
\bottomrule
\multicolumn{18}{l}{\textsuperscript{} Mean age at each timepoint is in brackets next to that timepoint header}\\
\multicolumn{18}{l}{\textsuperscript{} SE = standard error, P = p value, N = sample size}\\
