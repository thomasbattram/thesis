...
```{r h2ewas-pheno-qc, message=FALSE, results="asis", fig.cap='(ref:h2ewas-pheno-qc-cap)', out.width="75%", out.height="75%", fig.scap='(ref:h2ewas-pheno-qc-scap)'}
```
...
```{r h2ewas-pheno-corr-all, message=FALSE, results="asis", fig.cap='(ref:h2ewas-pheno-corr-all-cap)', fig.scap='(ref:h2ewas-pheno-corr-all-scap)'}
```
...
```{r h2ewas-pheno-corr-subset, message=FALSE, results="asis", fig.cap='(ref:h2ewas-pheno-corr-subset-cap)', fig.scap='(ref:h2ewas-pheno-corr-subset-scap)'}
```
...
```{r h2ewas-sens, message=FALSE, results="asis", fig.cap='(ref:h2ewas-sens-cap)', fig.scap='(ref:h2ewas-sens-scap)'}
```
...
```{r h2ewas-dmp-roc-curve, message=FALSE, results="asis", fig.cap='(ref:h2ewas-dmp-roc-curve-cap)', fig.scap='(ref:h2ewas-dmp-roc-curve-scap)'}
```
