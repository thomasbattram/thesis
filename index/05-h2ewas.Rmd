...
```{r h2ewas-model-comp, message=FALSE, results="asis", fig.cap='(ref:h2ewas-model-comp-cap)'}
```
...
```{r h2ewas-pheno-qc, message=FALSE, results="asis", fig.cap='(ref:h2ewas-pheno-qc-cap)', out.width="75%", out.height="75%"}
```
...
```{r h2ewas-pheno-corr-all, message=FALSE, results="asis", fig.cap='(ref:h2ewas-pheno-corr-all-cap)'}
```

(ref:h2ewas-pheno-corr-subset-cap) Correlation between the 400 traits with a correlation of 1 - [r] < 0.4.

```{r h2ewas-pheno-corr-subset, message=FALSE, results="asis", fig.cap='(ref:h2ewas-pheno-corr-subset-cap)'}
```
...
```{r h2ewas-study-design, message=FALSE, results="asis", fig.cap='(ref:h2ewas-study-design-cap)'}
```
...
```{r h2ewas-estimates, message=FALSE, results="asis", fig.cap='(ref:h2ewas-estimates-cap)'}
```
...
```{r h2ewas-sens, message=FALSE, results="asis", fig.cap='(ref:h2ewas-sens-cap)'}
```
...
```{r h2ewas-dmp-dist, message=FALSE, results="asis", fig.cap='(ref:h2ewas-dmp-dist-cap)'}
```
...
```{r dmps-and-h2ewas, message=FALSE, results="asis", fig.cap='(ref:dmps-and-h2ewas-cap)'}
```
...
```{r h2ewas-dmp-roc-curve, message=FALSE, results="asis", fig.cap='(ref:h2ewas-dmp-roc-curve-cap)'}
```
